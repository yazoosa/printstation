    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {quote.quote_items.map((item) => (
                    <div key={item.item_id} className="grid grid-cols-12 gap-3">
                      <div className="col-span-5">
          ...
          {/* Layout Calculations Card */}
<Card>
  <CardContent className="pt-6">
    <h3 className="text-lg font-semibold mb-4">Layout Calculations</h3>
    <div className="grid grid-cols-3 gap-6">
      <div className="space-y-1">
        <Label className="text-sm text-muted-foreground">Repeats per Sheet</Label>
        <p className="font-medium">
          {quote.layout_calculations?.repeats || '-'}
        </p>
      </div>
      ...
      <div className="space-y-1">
        ...
        <p className="font-medium">
          {quote.layout_calculations?.layout || '-'}
        </p>
      </div>
      ...
      <div className="space-y-1">
        ...
        <p className="font-medium">
          {quote.layout_calculations?.sheets || '-'}
        </p>
      </div>
    </div>
  </CardContent>
